...
fn compare_hash_performance() {
    ...
    println!("BLAKE3 (small) time for {} iterations: {:?}", iterations, blake3_s_time);
    ...
    println!("BLAKE3 (fast) time for {} iterations: {:?}", iterations, blake3_f_time);
    ...
    println!("SHA2 (small) time for {} iterations: {:?}", iterations, sha2_s_time);
    ...
    println!("SHA2 (fast) time for {} iterations: {:?}", iterations, sha2_f_time);
    ...
    println!("SHAKE (small) time for {} iterations: {:?}", iterations, shake_s_time);
    ...
    println!("SHAKE (fast) time for {} iterations: {:?}", iterations, shake_f_time);

    println!("\nRelative performance (small variants):");
    println!("BLAKE3 vs SHA2: {:.2}x", sha2_s_time.as_secs_f64() / blake3_s_time.as_secs_f64());
    println!("BLAKE3 vs SHAKE: {:.2}x", shake_s_time.as_secs_f64() / blake3_s_time.as_secs_f64());

    println!("\nRelative performance (fast variants):");
    println!("BLAKE3 vs SHA2: {:.2}x", sha2_f_time.as_secs_f64() / blake3_f_time.as_secs_f64());
    println!("BLAKE3 vs SHAKE: {:.2}x", shake_f_time.as_secs_f64() / blake3_f_time.as_secs_f64());
}
